...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__3940__auto__,writer__3941__auto__,opt__3942__auto__){return cljs.core._write.call(null,writer__3941__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_19523 = 0;while(true){
if((i_19523 < arr.length))
{(arr[i_19523] = null);
{
var G__19524 = (i_19523 + 1);
i_19523 = G__19524;
continue;
}
} else
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__3940__auto__,writer__3941__auto__,opt__3942__auto__){return cljs.core._write.call(null,writer__3941__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_19530 = (self__.level + 1);while(true){
if((i_19530 <= (new_level + 1)))
{(update[i_19530] = self__.header);
{
var G__19531 = (i_19530 + 1);
i_19530 = G__19531;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_19532 = 0;while(true){
if((i_19532 <= self__.level))
{var links_19533 = (update[i_19532]).forward;if(((links_19533[i_19532]) === x__$1))
{(links_19533[i_19532] = (x__$1.forward[i_19532]));
{
...
*/
cljs.core.async.impl.timers.timeout = (function timeout(msecs){var timeout__$1 = ((new Date()).valueOf() + msecs);var me = cljs.core.async.impl.timers.timeouts_map.ceilingEntry(timeout__$1);var or__3391__auto__ = (cljs.core.truth_((function (){var and__3379__auto__ = me;if(cljs.core.truth_(and__3379__auto__))
{return (me.key < (timeout__$1 + cljs.core.async.impl.timers.TIMEOUT_RESOLUTION_MS));
} else
{return and__3379__auto__;
}
})())?me.val:null);if(cljs.core.truth_(or__3391__auto__))
