...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t19564 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t19564 = (function (val,box,meta19565){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t19564.cljs$lang$type = true;
cljs.core.async.impl.channels.t19564.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t19564";
cljs.core.async.impl.channels.t19564.cljs$lang$ctorPrWriter = (function (this__3940__auto__,writer__3941__auto__,opt__3942__auto__){return cljs.core._write.call(null,writer__3941__auto__,"cljs.core.async.impl.channels/t19564");
});
cljs.core.async.impl.channels.t19564.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t19564.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_19566){var self__ = this;
var _19566__$1 = this;return self__.meta19565;
});
cljs.core.async.impl.channels.t19564.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_19566,meta19565__$1){var self__ = this;
var _19566__$1 = this;return (new cljs.core.async.impl.channels.t19564(self__.val,self__.box,meta19565__$1));
});
cljs.core.async.impl.channels.__GT_t19564 = (function __GT_t19564(val__$1,box__$1,meta19565){return (new cljs.core.async.impl.channels.t19564(val__$1,box__$1,meta19565));
});
}
return (new cljs.core.async.impl.channels.t19564(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__3943__auto__,writer__3944__auto__,opts__3945__auto__){return cljs.core._write.call(null,writer__3944__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__3940__auto__,writer__3941__auto__,opt__3942__auto__){return cljs.core._write.call(null,writer__3941__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_19567 = self__.takes.pop();if((taker_19567 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_19567))
{var take_cb_19568 = cljs.core.async.impl.protocols.commit.call(null,taker_19567);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_19568,taker_19567){
return (function (){return take_cb_19568.call(null,null);
});})(take_cb_19568,taker_19567))
);
} else
{}
{
