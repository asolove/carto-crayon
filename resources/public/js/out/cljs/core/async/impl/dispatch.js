...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_19558 = 0;while(true){
var m_19559 = cljs.core.async.impl.dispatch.tasks.pop();if((m_19559 == null))
{} else
{m_19559.call(null);
if((count_19558 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__19560 = (count_19558 + 1);
count_19558 = G__19560;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__3379__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__3379__auto__)
