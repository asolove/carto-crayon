...
{{
var G__16770 = cljs.core.pop.call(null,v__$1);
v__$1 = G__16770;
continue;
}
} else
...
{var pred__16774 = cljs.core._EQ_;var expr__16775 = limit;if(cljs.core.truth_(pred__16774.call(null,1,expr__16775)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__16774.call(null,2,expr__16775)))
...
var G__16777 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__16778 = (limit__$1 - 1);
var G__16779 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__16777;
limit__$1 = G__16778;
parts = G__16779;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___16781 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___16781))
{var replacement_16782 = temp__4090__auto___16781;buffer.append([cljs.core.str(replacement_16782)].join(''));
} else
{buffer.append(ch);
}
{
var G__16783 = (index + 1);
index = G__16783;
continue;
}
}
